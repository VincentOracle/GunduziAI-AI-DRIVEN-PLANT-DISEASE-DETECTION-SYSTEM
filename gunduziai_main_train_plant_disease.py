...
!pip install kaggle # type: ignore
...
!mkdir -p ~/.kaggle # type: ignore
!mv kaggle.json ~/.kaggle/ # type: ignore
...
1. I Choose a small learning rate default 0.001 we are taking 0.0001
2. There may be chance of Underfitting, so I increased the number of neuron
3. Adde more Convolution layer to extract more feature from images since there may be possibilty that model was 
unable to capture relevant feature or model is confusing due to lack of features, so I fed  it with more feature
